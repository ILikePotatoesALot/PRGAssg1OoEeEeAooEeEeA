...
namespace AssgCode
{
    internal class Terminal
    {
        ...
        public void PrintAirlineFees(Dictionary<string, Airline> airlinesDictionary, Dictionary<string, Flight> flightDict, Dictionary<string, BoardingGate> boardingGateDict)
        {
                
                Airline.DisplayFees(airlinesDictionary, flightDict, boardingGateDict);
